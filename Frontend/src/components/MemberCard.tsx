...
const MemberCard: React.FC<MemberProps> = ({ id, name, role, skills, image, onClick }) => {
    ...
    const CardContent = (
        <div className="group relative w-full aspect-[3/4] rounded-[32px] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 border border-zinc-100 dark:border-zinc-800 cursor-pointer bg-white dark:bg-zinc-900">
